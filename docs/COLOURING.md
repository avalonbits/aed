...
| | |
|---|---|
| [`line_state()`](../src/cmd_ops.c#L594) | inside the window it is a lookup; below it the window grows ([`extend_lines`](../src/cmd_ops.c#L534)); above it the window starts again there ([`refill_lines`](../src/cmd_ops.c#L579)) |
| [`set_line_state()`](../src/cmd_ops.c#L616) | records what a paint has just worked out |
| [`lines_moved()`](../src/cmd_ops.c#L657) | the document gained or lost a line at a point |
| [`line_at_row()`](../src/cmd_ops.c#L694) | `synTop_ + (ypos - topY_)`, the only place a row becomes a line |
...
So the screen asks. [`scr_set_colourer()`](../src/screen.c#L1286) hands it two
...
[`ed_colour_row()`](../src/cmd_ops.c#L134) — and every path that shows the
cursor asks the second — [`ed_colour_cell()`](../src/cmd_ops.c#L172). **A row

...
| | |
|---|---|
| [`line_state()`](../src/cmd_ops.c#L605) | inside the window it is a lookup; below it the window grows ([`extend_lines`](../src/cmd_ops.c#L545)); above it the window starts again there ([`refill_lines`](../src/cmd_ops.c#L590)) |
| [`set_line_state()`](../src/cmd_ops.c#L627) | records what a paint has just worked out |
| [`lines_moved()`](../src/cmd_ops.c#L668) | the document gained or lost a line at a point |
| [`line_at_row()`](../src/cmd_ops.c#L705) | `synTop_ + (ypos - topY_)`, the only place a row becomes a line |
...
[`ed_colour_row()`](../src/cmd_ops.c#L145) — and every path that shows the
cursor asks the second — [`ed_colour_cell()`](../src/cmd_ops.c#L183). **A row

...
| how much of the buffer stays empty | [`prime_spare`](../src/text_buffer.c#L1109) | a quarter |
...
`2 * TB_MARGIN` of 32,768, so [`tb_settle`](../src/text_buffer.c#L1050) has
...
[`tb_copy`](../src/text_buffer.c#L1922) already marks a copy as read-only, and

...
[`main()`](../src/main.c#L25) ·
[`ed_init()`](../src/editor.c#L237) ·
[`ed_run()`](../src/editor.c#L553) ·
[`read_input()`](../src/editor.c#L788) ·
[`ctrlCmds()`](../src/editor.c#L644) ·
[`editCmds()`](../src/editor.c#L739) ·
[`ed_selection_for()`](../src/editor.c#L425) ·
...
[`ctrlCmds()`](../src/editor.c#L644) for a key with CTRL held,
[`editCmds()`](../src/editor.c#L739) for one without — and both are exported so
...
[`ed_selection_for()`](../src/editor.c#L425) decides what a keystroke does to
...
* **A command** needs a function in `cmd_ops.c`, a declaration in `cmd_ops.h`, a
  case in [`ctrlCmds()`](../src/editor.c#L644) or
  [`editCmds()`](../src/editor.c#L739), a row in the help table in
...
* **If it owns the selection**, say so in
  [`owns_selection()`](../src/editor.c#L410), or the loop will take the

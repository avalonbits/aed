...
[`ed_selection_for()`](../src/editor.c#L402) ·
...
[`ed_selection_for()`](../src/editor.c#L402) decides what a keystroke does to
...
* **If it owns the selection**, say so in
  [`owns_selection()`](../src/editor.c#L387), or the loop will take the

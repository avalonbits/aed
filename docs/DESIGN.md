...
[`cmd_repaint_rows()`](../src/cmd_ops.c#L804)
...
[`cmd_repaint_rows()`](../src/cmd_ops.c#L804) takes a range, and most commands
pass a single row.

[`screen`](../src/screen.h#L65) derives its geometry from the font's cell size,
